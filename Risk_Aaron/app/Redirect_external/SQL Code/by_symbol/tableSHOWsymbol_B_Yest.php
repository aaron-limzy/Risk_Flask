...
FROM live1.mt4_trades WHERE SYMBOL LIKE '%".$Symbol."%' AND CLOSE_TIME BETWEEN DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 2 DAY) AND DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 1 DAY) AND CMD < 2 
...
CASE WHEN mt4_trades.REASON = 0 THEN 'Client' WHEN mt4_trades.REASON = 1 THEN 'Expert' WHEN mt4_trades.REASON = 2 THEN 'Dealer' WHEN mt4_trades.REASON = 3 THEN 'Signal' WHEN mt4_trades.REASON = 4 THEN '4' WHEN mt4_trades.REASON = 5 THEN 'Mobile' ELSE 00 END AS REASON,SWAPS AS SWAPS,PROFIT AS PROFIT
FROM live2.mt4_trades WHERE SYMBOL LIKE '%".$Symbol."%' AND CLOSE_TIME BETWEEN DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 2 DAY) AND DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 1 DAY) AND CMD < 2 
AND (mt4_trades.`GROUP` IN (SELECT `GROUP` FROM live5.group_table WHERE BOOK = 'B'))
UNION
...
CASE WHEN mt4_trades.REASON = 0 THEN 'Client' WHEN mt4_trades.REASON = 1 THEN 'Expert' WHEN mt4_trades.REASON = 2 THEN 'Dealer' WHEN mt4_trades.REASON = 3 THEN 'Signal' WHEN mt4_trades.REASON = 4 THEN '4' WHEN mt4_trades.REASON = 5 THEN 'Mobile' ELSE 00 END AS REASON,SWAPS AS SWAPS,PROFIT AS PROFIT
FROM live3.mt4_trades WHERE SYMBOL LIKE '%".$Symbol."%' AND CLOSE_TIME BETWEEN DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 2 DAY) AND DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 1 DAY) AND CMD < 2 
AND (mt4_trades.`GROUP` IN (SELECT `GROUP` FROM live5.group_table WHERE BOOK = 'B'))
UNION
...
CASE WHEN mt4_trades.REASON = 0 THEN 'Client' WHEN mt4_trades.REASON = 1 THEN 'Expert' WHEN mt4_trades.REASON = 2 THEN 'Dealer' WHEN mt4_trades.REASON = 3 THEN 'Signal' WHEN mt4_trades.REASON = 4 THEN '4' WHEN mt4_trades.REASON = 5 THEN 'Mobile' ELSE 00 END AS REASON,SWAPS AS SWAPS,PROFIT AS PROFIT
FROM live5.mt4_trades WHERE SYMBOL LIKE '%".$Symbol."%' AND CLOSE_TIME BETWEEN DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 2 DAY) AND DATE_SUB(DATE_FORMAT(NOW(),'%Y-%m-%d 23:00:00'),INTERVAL 1 DAY) AND CMD < 2 
AND (mt4_trades.`GROUP` IN (SELECT `GROUP` FROM live5.group_table WHERE BOOK = 'B'))
