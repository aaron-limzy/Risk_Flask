...
# Want to create a SQL insert for clients having no trades.
# Want to send notification when client has no trades of that particular symbol.
class Client_No_Trade_Form(FlaskForm):
