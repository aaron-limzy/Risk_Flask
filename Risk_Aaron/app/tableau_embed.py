# Want to store all the tableau URL here.
...
def symbol_float_tableau():
    ...
    <div class='tableauPlaceholder' style='width: 1480px; height: 1050px;'><object class='tableauViz' width='1480' height='1050' style='display:none;'>
