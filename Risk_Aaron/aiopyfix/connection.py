...
class FIXConnectionHandler(object):
    ...
    async def _notifyMessageObservers(self, msg, direction, persistMessage=False):
    ...
    async def sendMsg(self, msg):
        ...
        #logging.info("SendMsg: {}".format(msg))
        ...
        logging.info("(Sending) decodedMsg: {}".format(decodedMsg))
